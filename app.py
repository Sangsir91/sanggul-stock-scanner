...
.modern-stock-head{display:grid;grid-template-columns:minmax(260px,1.2fr) repeat(4,minmax(120px,.55fr));gap:10px;align-items:stretch;margin:8px 0 12px}.stock-identity,.quote-card{background:linear-gradient(180deg,#0d263c,#081623);border:1px solid #1c4868;border-radius:13px;padding:12px 15px}.stock-identity{border-left:4px solid #00d084}.stock-code{font-size:2rem;font-weight:950;line-height:1;color:#fff;letter-spacing:-.04em}.stock-name{font-size:.82rem;color:#91aac0;margin-top:5px}.stock-tag{display:inline-block;margin-top:8px;padding:4px 8px;border-radius:999px;background:#0a3550;border:1px solid #1c668f;color:#70d2ff;font-size:.65rem;font-weight:850}.quote-label{font-size:.65rem;color:#7897b0;text-transform:uppercase;font-weight:800;letter-spacing:.08em}.quote-value{font-size:1.28rem;font-weight:950;color:#fff;margin-top:4px}.quote-note{font-size:.68rem;color:#00d084;margin-top:3px}.primary-card{background:linear-gradient(135deg,#0b2d45,#0a1b2a);border:1px solid #246087;border-radius:13px;padding:10px 12px;min-height:70px}.primary-label{font-size:.62rem;color:#7897b0;text-transform:uppercase;letter-spacing:.08em;font-weight:850}.primary-value{font-size:.96rem;color:#fff;font-weight:900;line-height:1.2;margin-top:6px;word-break:break-word}.primary-note{font-size:.64rem;color:#8fa9c1;margin-top:4px}.app-shell-note{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:8px 12px;border:1px solid #183b57;border-radius:11px;background:linear-gradient(90deg,#071827,#0a2033);margin:4px 0 12px;color:#8fa9c1;font-size:.72rem}.clean-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.clean-panel{background:#081725;border:1px solid #193f5b;border-radius:13px;padding:13px}.clean-panel h4{margin:0 0 8px;color:#f4f8ff;font-size:.82rem}.kv{display:flex;justify-content:space-between;gap:10px;padding:6px 0;border-bottom:1px solid #143149;font-size:.72rem}.kv:last-child{border-bottom:0}.kv .label{color:#7897b0}.kv .value{color:#e9f3ff;font-weight:800;text-align:right}.footer-note{margin-top:15px;padding:9px 12px;border-top:1px solid #173650;color:#6f8da7;font-size:.67rem;text-align:center}
.dashboard-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin:8px 0 10px}.dashboard-kpi{position:relative;display:flex;align-items:center;gap:12px;min-height:78px;padding:12px 14px;border-radius:14px;border:1px solid #1c4969;background:linear-gradient(145deg,#0d2941 0%,#081827 72%);box-shadow:0 10px 28px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.035);overflow:hidden}.dashboard-kpi:after{content:"";position:absolute;right:-28px;top:-34px;width:95px;height:95px;border-radius:50%;background:rgba(22,131,255,.08)}.dashboard-kpi .kpi-icon{width:38px;height:38px;min-width:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:18px;font-weight:900;background:#0b3554;border:1px solid #176b9b}.dashboard-kpi .kpi-copy{min-width:0;position:relative;z-index:1}.dashboard-kpi .kpi-label{font-size:.67rem;color:#8ba7bd;line-height:1.1;font-weight:750;text-transform:none;letter-spacing:.01em}.dashboard-kpi .kpi-number{font-size:1.28rem;line-height:1.05;color:#f6fbff;font-weight:950;margin-top:5px}.dashboard-kpi.green{border-color:#155e55}.dashboard-kpi.green .kpi-icon{color:#00e59a;background:#073c32;border-color:#087c62}.dashboard-kpi.purple{border-color:#4b3c68}.dashboard-kpi.purple .kpi-icon{color:#c77cff;background:#2b1948;border-color:#704ca0}.dashboard-kpi.gold{border-color:#66501e}.dashboard-kpi.gold .kpi-icon{color:#ffd44d;background:#44330a;border-color:#9b7818}.dashboard-kpi-wide{display:flex;align-items:center;gap:12px;min-height:66px;padding:11px 14px;margin-bottom:12px;border-radius:14px;border:1px solid #66501e;background:linear-gradient(145deg,#172b31 0%,#0a1b26 75%);box-shadow:0 10px 28px rgba(0,0,0,.16)}.dashboard-kpi-wide .wide-icon{width:36px;height:36px;min-width:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:#44330a;color:#ffd44d;border:1px solid #9b7818;font-size:18px}.dashboard-kpi-wide .wide-label{font-size:.7rem;color:#a8b9c8}.dashboard-kpi-wide .wide-number{font-size:1.25rem;font-weight:950;color:#fff;margin-top:3px}.section-title.compact{font-size:.98rem;margin-top:.85rem;margin-bottom:.45rem}
@media(max-width:900px){.dashboard-kpis{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.dashboard-kpi{min-height:70px;padding:10px}.dashboard-kpi .kpi-number{font-size:1.15rem}.hero-pro{padding:15px 16px;border-radius:15px}.hero-desc{font-size:.78rem}}@media(max-width:520px){.dashboard-kpi{gap:8px;padding:9px}.dashboard-kpi .kpi-icon{width:32px;height:32px;min-width:32px;font-size:15px}.dashboard-kpi .kpi-label{font-size:.61rem}.dashboard-kpi .kpi-number{font-size:1.05rem}.dashboard-kpi-wide{min-height:58px;padding:9px 11px}.dashboard-kpi-wide .wide-number{font-size:1.08rem}}
@media(max-width:1100px){.modern-stock-head{grid-template-columns:1fr 1fr}.stock-identity{grid-column:1/-1}.clean-grid{grid-template-columns:1fr 1fr}}@media(max-width:720px){.modern-stock-head{grid-template-columns:1fr 1fr}.stock-identity{grid-column:1/-1}.clean-grid{grid-template-columns:1fr}.hero-title{font-size:1.55rem}.app-shell-note{align-items:flex-start;flex-direction:column}}
</style>
...
if mode == "Analisis 1 Saham":
    ...
    st.markdown('<div class="section-title compact">📋 Enrich Full IDX <span style="color:#6d8fa8;font-size:.7rem;font-weight:650">· buka hanya saat diperlukan</span></div>', unsafe_allow_html=True)
